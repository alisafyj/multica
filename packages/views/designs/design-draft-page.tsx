          ...
          <div className="grid gap-4 lg:grid-cols-[1fr_320px]">
              ...
              <div className="rounded-lg border bg-background p-4">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">{isSemanticDraft ? "服务端已将 PageSpec 编译为可预览的设计草稿。" : "生成或打开生成的设计稿前，请检查槽位值和安全补丁。"}</p>
                  </div>
              ...
              <section className="rounded-lg border bg-background p-4">
                <div className="mb-3 flex items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">{isSemanticDraft ? "预览来自编译后的 Native Design JSON。" : draft.generated_file_id ? "预览已生成设计稿。" : "预览来源模板，并临时套用文本 slot 与 safe patch。"}</p>
                  </div>
            ...
            <aside className="space-y-3">
              <div className="rounded-lg border bg-background p-3">
                <div className="text-sm font-medium">草稿操作</div>
                <div className="mt-3 space-y-2">
                  {draft.generated_file_id ? (
                    ...
                    <div className="rounded-md border bg-muted/30 px-3 py-2 text-xs text-muted-foreground">当前草稿可预览</div>
                  ) : (
