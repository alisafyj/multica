...
- `server/migrations/241_design_delivery.up.sql`
- `server/migrations/242_design_restore_task_delivery.up.sql`
- `server/migrations/243_design_delivery_cancel_audit.up.sql`
- `server/migrations/244_design_delivery_single_active_source.up.sql`
...
- `server/migrations/241_design_delivery.up.sql` — design delivery table and indexes.
- `server/migrations/242_design_restore_task_delivery.up.sql` — restore task to delivery binding.
- `server/migrations/243_design_delivery_cancel_audit.up.sql` — cancellation reason and audit fields.
- `server/migrations/244_design_delivery_single_active_source.up.sql` — source Issue can only have one active delivery.
