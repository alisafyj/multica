...
| `execution_budget_exceeded` | Exhausted the spending budget configured for this run; this is not the provider account quota | Narrow the issue scope, then retry manually |
