...
type Task struct {
	...
	DesignSystemProfileAnalyzeContext json.RawMessage       `json:"design_system_profile_analyze_context,omitempty"`     // UI specification analysis context
	TemplateBlueprintAnalyzeContext   json.RawMessage       `json:"design_template_blueprint_analyze_context,omitempty"` // template Blueprint analysis context
	ProjectDesignSystemContext        json.RawMessage       `json:"project_design_system_context,omitempty"`             // project design-system generation context
