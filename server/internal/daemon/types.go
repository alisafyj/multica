...
type Task struct {
	...
	RegenerateQuickActionsFor         string                 `json:"regenerate_quick_actions_for,omitempty"`     // set → run ONLY the suggestion pass (no reply) and supplement the named turn's assistant row
