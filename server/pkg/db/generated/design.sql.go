...
const getDesignRestoreTaskExecutionStatus = `-- name: GetDesignRestoreTaskExecutionStatus :one
SELECT
...
type GetDesignRestoreTaskExecutionStatusParams struct {
	ID          pgtype.UUID `json:"id"`
	WorkspaceID pgtype.UUID `json:"workspace_id"`
}

type GetDesignRestoreTaskExecutionStatusRow struct {
	RestoreTaskID         pgtype.UUID        `json:"restore_task_id"`
	AgentTaskID           pgtype.UUID        `json:"agent_task_id"`
	AgentTaskStatus       pgtype.Text        `json:"agent_task_status"`
	RuntimeID             pgtype.UUID        `json:"runtime_id"`
	AgentTaskDispatchedAt pgtype.Timestamptz `json:"agent_task_dispatched_at"`
	AgentTaskStartedAt    pgtype.Timestamptz `json:"agent_task_started_at"`
	AgentTaskCompletedAt  pgtype.Timestamptz `json:"agent_task_completed_at"`
	AgentTaskCreatedAt    pgtype.Timestamptz `json:"agent_task_created_at"`
	AgentTaskError        pgtype.Text        `json:"agent_task_error"`
	AgentTaskWaitReason   pgtype.Text        `json:"agent_task_wait_reason"`
...
func (q *Queries) GetDesignRestoreTaskExecutionStatus(ctx context.Context, arg GetDesignRestoreTaskExecutionStatusParams) (GetDesignRestoreTaskExecutionStatusRow, error) {
	row := q.db.QueryRow(ctx, getDesignRestoreTaskExecutionStatus, arg.ID, arg.WorkspaceID)
	var i GetDesignRestoreTaskExecutionStatusRow
	err := row.Scan(
		&i.RestoreTaskID,
		&i.AgentTaskID,
		&i.AgentTaskStatus,
		&i.RuntimeID,
		&i.AgentTaskDispatchedAt,
		&i.AgentTaskStartedAt,
		&i.AgentTaskCompletedAt,
		&i.AgentTaskCreatedAt,
		&i.AgentTaskError,
		&i.AgentTaskWaitReason,
		&i.RuntimeStatus,
		&i.RuntimeLastSeenAt,
		&i.LastMessageSeq,
		&i.LastMessageAt,
